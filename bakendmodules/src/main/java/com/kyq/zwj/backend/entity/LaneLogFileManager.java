 ...
 */
public class LaneLogFileManager {
    private Integer stationNo;
    private Integer laneNo;
    private Date opeDate;
    private Integer softProFlag;
    ...
    public Integer getSoftProFlag() {
        return softProFlag;
    }

    public void setSoftProFlag(Integer softProFlag) {
        this.softProFlag = softProFlag;
    }
