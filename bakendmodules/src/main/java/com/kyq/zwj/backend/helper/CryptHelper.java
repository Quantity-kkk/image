...
public class CryptHelper {
    public static final String OTP_PROPERTY_KEY = "anony_otp_key";
    //获取TOP的密钥
    private static final String TOTP = SysconfigHelper.getProperty(OTP_PROPERTY_KEY);
